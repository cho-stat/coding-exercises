...
def delete_node(node_to_delete):
    ...
    # Assume b is the node to delete.
    # Have b assume the value of c, and point to whatever c pointed to
    # Keep moving the routing "one up" until you reach the end
    # Doesn't work if you are the last in the list :( 
